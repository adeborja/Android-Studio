package com.example.angel.calculadorabotones;
...
public class CalculadoraBotones extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calculadora_botones);
