...
public class Navegacion2 extends Fragment implements View.OnClickListener{
    ...
    */
    ...
    public static Navegacion2 newInstance(String miBoton1, String miBoton2)
    {
        Navegacion2 fragment = new Navegacion2();
